...
For organisation purposes, you can also group the module functions into a single object. In the example above, we're grouping the counter functions into a single object called `counter`.
